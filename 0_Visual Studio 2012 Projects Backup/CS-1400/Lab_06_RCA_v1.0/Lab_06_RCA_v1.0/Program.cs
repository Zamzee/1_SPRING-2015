...
// CS 1400 Section 003
// Project: CS1400_Lab_07
// Date: 4/27/2014 6:45 PM
...
static class Program
{
    ...
    static void Main()
    {
       ...
       // Console.ReadLine();
        ...
        Capt_Share= TotalGold * 0.12;     //10) Multiply TotalGold by 0.12 and Save result as Capt_Share (int)
        TotalGold= TotalGold - Capt_Share;  //11) Subtract Cap'n_Share from TotalGold
        First_Mate_Share= TotalGold * 0.08;   //12) Multiply TotalGold by .08 and Save results as 1st_Mate_Share (int)
        ...
        Console.WriteLine("Each crew member gets {0} pieces of Gold.  The PBA gets {1} pieces of Gold for Union Fees.", Crew_Cut, PBA_Fee);
