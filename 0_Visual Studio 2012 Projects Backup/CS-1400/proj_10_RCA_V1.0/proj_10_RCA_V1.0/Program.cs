...
namespace proj_10_RCA_V1._0
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            bowlers.sortBowlers();
            bowlers.printBowlers();
            
            for (int i = 0; i < count; i++)
            {
                Console.WriteLine("{0}", bowlers.getTeamData());
            }
            
            // Console.WriteLine("{0}", bowlers[i]);
           
            // Console.WriteLine("{0} {1}", bowlers.sortBowlers().getName(), bowlers.sortBowlers().getScore());
            // Display Results
